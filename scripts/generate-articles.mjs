...
const CATEGORY_DATA = {
  ...
  "beauty-wellness": {
    ...
    items: [
      ...
      ["Sundown Skincare Studio Sources Ingredients From Local Farms", "A Peoria skincare studio switched to locally farmed ingredients for its full product line.", "Peoria", "https://images.unsplash.com/photo-1585652757141-8aa63075f60b?auto=format&fit=crop&w=1200&h=800&q=80", "Unsplash/Alexandra Tran"],
      ["Desert Bloom Day Spa Opens First Yuma Location", "A regional spa chain opened its first Yuma location this month.", "Yuma", "https://images.unsplash.com/photo-1610462224500-b5e1b845b8f2?auto=format&fit=crop&w=1200&h=800&q=80", "Unsplash/Chelsea Shapouri"],
      ...
      ["Sunrise Mountain Spa Debuts Organic Skincare Line", "A Surprise spa introduced a new organic skincare line made with regional ingredients.", "Surprise", "https://images.unsplash.com/photo-1591343395902-1eb7770071e1?auto=format&fit=crop&w=1200&h=800&q=80", "Unsplash/Angela Bailey"],
  ...
  education: {
    ...
    split: [14, 3],
    items: [
      ["Arizona State University Opens New Engineering Innovation Hub", "ASU's Tempe campus opened a new hub dedicated to student engineering projects.", "Tempe", "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=1200&h=800&q=80", "Unsplash/Vasily Koloda"],
      ...
      ["Yavapai College Adds Renewable Energy Technician Program", "Yavapai College launched a new technician training program focused on renewable energy.", "Prescott", "https://images.unsplash.com/photo-1580537659466-0a139dfbb2be?auto=format&fit=crop&w=1200&h=800&q=80", "Unsplash/Kenny Eliason"],
